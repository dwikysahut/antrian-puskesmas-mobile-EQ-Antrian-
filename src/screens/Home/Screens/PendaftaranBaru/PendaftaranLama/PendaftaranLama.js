...
const PendaftaranLama = ({params, onChangeIndex}) => {
  ...
  const [selectedMember, setSelectedMember] = useState({item: ''});
              ...
              dialogCallback(
                ...
                () => {
                  ...
                  setFormField({
                    ...
                    pendidikan_terakhir: response.data.data.pendidikan_terakhir,
                    status_anggota_keluarga:
  ...
  const onSubmitFilter = () => {
    ...
    if (!isSubmitted) {
      return showToast(
        ALERT_TYPE.DANGER,
        'Oopss..',
        'Pilih Anggota Keluarga yang memiliki kuota',
      );
    }
    getInformasiKuotaAntrian(
      queryString.stringify({
